...
public class JwtFilter extends GenericFilterBean {
    ...
    // Manejar una solicitud (request), una respuesta (response) y una cadena de
    // filtros (filterChain)

    // Este filtro intercepta todas esas solicitudes, y revisa que tengan la
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain filterChain)
        ...
        // Aqui delimitamos las solicitudes que si o que no necesitan de una
        // autorizacion (va en el encabezado)
